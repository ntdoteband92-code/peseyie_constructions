...
import { createMaterial, createMaterialInward, createExplosiveEntry, deleteMaterial, deleteExplosiveEntry } from '@/app/actions/materials'
...
export async function DELETE(request: Request) {
  try {
    ...
    let result
    if (type === 'explosive') {
      result = await deleteExplosiveEntry(id)
    } else {
